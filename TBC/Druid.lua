...
spec:RegisterCombatLogEvent(
    function(_, subtype, _, sourceGUID, sourceName, _, _, destGUID, destName, destFlags, _, spellID, spellName)
...
local function rage_amount()
    ...
    local c =
        (state.level > 70 and 1.4139 or 1) * (0.0091107836 * (state.level ^ 2) + 3.225598133 * state.level + 4.2652911)
    local f = 3.5
    local s = 2.5
...
spec:RegisterAuras(
    {
        ...
        bash = {
            id = 5211,
            duration = function()
                return 2 + (0.5 * talent.brutal_impact.rank)
            end,
            max_stack = 1,
            copy = {5211, 6798, 8983}
        },
        ...
        sharpened_claws = {
            -- TODO: Check Aura (https://wowhead.com/wotlk/spell=16944)
            id = 16942,
            duration = 3600,
            max_stack = 1,
...
spec:RegisterAbilities(
    {
        ...
        bash = {
            ...
            gcd = "spell",
            spend = function()
                return (buff.clearcasting.up and 0) or 10
            end,
            spendType = "rage",
            startsCombat = true,
            texture = 132114,
        ...
        cat_form = {
            ...
            gcd = "spell",
            spend = function()
                return 0.35 * (1 - (talent.natural_shapeshifter.rank * 0.1))
            end,
            spendType = "mana",
            startsCombat = true,
            texture = 132115,
        ...
        claw = {
            ...
            gcd = "totem",
            spend = function()
                return ((buff.clearcasting.up and 0) or 45) - talent.ferocity.rank
            end,
            spendType = "energy",
            startsCombat = true,
            texture = 132140,
        ...
        mangle_bear = {
            ...
            gcd = "totem",
            spend = function()
                return ((buff.clearcasting.up and 0) or 20) - talent.ferocity.rank
            end,
            spendType = "rage",
            startsCombat = true,
            texture = 132135,
        ...
        lacerate = {
            ...
            gcd = "totem",
            spend = function()
                return ((buff.clearcasting.up and 0) or 15) - talent.shredding_attacks.rank
            end,
            spendType = "rage",
            startsCombat = true,
            texture = 132131,
        ...
        entangling_roots = {
            id = 339,
            cast = function()
                return buff.natures_swiftness.up and 0 or 1.5 - (buff.natures_grace.up and 0.5 or 0)
            end,
            cooldown = 0,
            gcd = "spell",
            spend = function()
                return (buff.clearcasting.up and 0) or 0.07
            end,
            spendType = "mana",
            startsCombat = true,
            texture = 136100,
        ...
        ferocious_bite = {
            ...
            gcd = "totem",
            spend = function()
                return (buff.clearcasting.up and 0) or 35
            end,
            spendType = "energy",
            startsCombat = true,
            texture = 132127,
        ...
        healing_touch = {
            id = 5185,
            cast = function()
                return buff.natures_swiftness.up and 0 or
                    3.5 - (buff.natures_grace.up and 0.5 or 0) - (talent.naturalist.rank * 0.1)
            end,
            cooldown = 0,
            gcd = "spell",
            spend = function()
                return 0.17 * (1 - (talent.moonglow.rank * 0.03)) * (1 - (talent.tranquil_spirit.rank * 0.02))
            end,
            spendType = "mana",
            usable = function()
                return buff.moonkin_form.down
            end,
            startsCombat = true,
            texture = 136041,
            handler = function()
        ...
        hurricane = {
            ...
            gcd = "spell",
            spend = function()
                return (buff.clearcasting.up and 0) or 0.81
            end,
            spendType = "mana",
            startsCombat = true,
            texture = 136018,
            aura = "hurricane",
            tick_time = function()
                return class.auras.hurricane.tick_time
            end,
            start = function()
        ...
        insect_swarm = {
            ...
            gcd = "spell",
            spend = function()
                return (buff.clearcasting.up and 0) or 0.08
            end,
            spendType = "mana",
            talent = "insect_swarm",
            startsCombat = true,
        ...
        maul = {
            ...
            nobuff = "maul",
            usable = function()
                return not buff.maul.up
            end,
            readyTime = function()
                return buff.maul.expires
            end,
        ...
        moonfire = {
            ...
            gcd = "spell",
            spend = function()
                return ((buff.clearcasting.up and 0 or 0.21) * (1 - talent.moonglow.rank * 0.03)) *
                    (buff.moonkin_form.up and 0.5 or 1)
            end,
            spendType = "mana",
            startsCombat = true,
            texture = 136096,
        ...
        pounce = {
            ...
            gcd = "totem",
            spend = function()
                return (buff.clearcasting.up and 0) or 50
            end,
            spendType = "energy",
            startsCombat = true,
            texture = 132142,
        ...
        rake = {
            ...
            gcd = "totem",
            spend = function()
                return (buff.clearcasting.up and 0) or (40 - talent.ferocity.rank)
            end,
            spendType = "energy",
            startsCombat = true,
            texture = 132122,
            readyTime = function()
                return debuff.rake.remains
            end,
            handler = function()
        ...
        ravage = {
            ...
            gcd = "totem",
            spend = function()
                return (buff.clearcasting.up and 0) or 60
            end,
            spendType = "energy",
            startsCombat = true,
            texture = 132141,
        ...
        rebirth = {
            id = 20484,
            cast = function()
                return buff.natures_swiftness.up and 0 or 2 - (buff.natures_grace.up and 0.5 or 0)
            end,
            cooldown = 1800,
            gcd = "spell",
            spend = 0.68,
        ...
        regrowth = {
            ...
            gcd = "spell",
            spend = function()
                return ((buff.clearcasting.up and 0) or 0.29) * (1 - (talent.moonglow.rank * 0.03))
            end,
            spendType = "mana",
            usable = function()
                return buff.moonkin_form.down
        ...
        rejuvenation = {
            ...
            gcd = "spell",
            spend = function()
                return ((buff.clearcasting.up and 0) or 0.18) * (1 - (talent.moonglow.rank * 0.03))
            end,
            spendType = "mana",
            usable = function()
                return buff.moonkin_form.down
        ...
        rip = {
            ...
            gcd = "totem",
            spend = function()
                return buff.clearcasting.up and 0 or 30
            end,
            spendType = "energy",
            startsCombat = true,
            texture = 132152,
            ...
            readyTime = function()
                return debuff.rip.remains
            end, -- Clipping rip is a DPS loss and an unpredictable recommendation. AP snapshot on previous rip will prevent overriding
            handler = function()
        ...
        shred = {
            ...
            gcd = "totem",
            spend = function()
                return (buff.clearcasting.up and 0) or (60 - (talent.shredding_attacks.rank * 9))
            end,
            spendType = "energy",
            startsCombat = true,
            texture = 136231,
        ...
        starfire = {
            ...
            gcd = "spell",
            spend = function()
                return (buff.clearcasting.up and 0 or 0.16) * (1 - talent.moonglow.rank * 0.03)
            end,
            spendType = "mana",
            startsCombat = true,
            texture = 135753,
        ...
        thorns = {
            ...
            gcd = "spell",
            spend = function()
                return (buff.clearcasting.up and 0) or 0.17
            end,
            spendType = "mana",
            startsCombat = true,
            texture = 136104,
        ...
        wrath = {
            ...
            cast = function()
                return buff.natures_swiftness.up and 0 or
                    2 - (talent.starlight_wrath.rank * 0.1) - (buff.natures_grace.up and 0.5 or 0)
            end,
            cooldown = 0,
            gcd = "spell",
            spend = function()
                return (buff.clearcasting.up and 0 or 0.08) * (1 - (talent.moonglow.rank * 0.03))
            end,
            spendType = "mana",
            startsCombat = true,
            texture = 136006,
...
spec:RegisterSetting(
    ...
    true,
    {
        ...
        desc = strformat(
            "If unchecked, %s will not be recommended.",
...
spec:RegisterSetting(
    ...
    20,
    {
        ...
        desc = strformat(
            "If set to zero or more, %s will be recommended when reaching that mana percentage. Setting to -1 will disable the use of %s.\n\n" ..
                "Default: 20",
            Hekili:GetSpellLinkWithTexture(spec.abilities.innervate.id),
            Hekili:GetSpellLinkWithTexture(spec.abilities.innervate.id)
        ),
...
spec:RegisterSetting(
    ...
    5,
    {
        ...
        desc = strformat(
            "Specify the minimum combo points for %s to be recommended\n\n" .. "Default: 0",
            Hekili:GetSpellLinkWithTexture(spec.abilities.rip.id),
            Hekili:GetSpellLinkWithTexture(spec.abilities.rip.id)
        ),
        width = "double",
...
spec:RegisterSetting(
    ...
    5,
    {
        type = "range",
        name = strformat(
            "Minimum Combo Points for %s",
            Hekili:GetSpellLinkWithTexture(spec.abilities.ferocious_bite.id)
        ),
        desc = strformat(
            "Specify the minimum combo points for %s. Set to 0 to disable %s.\n\n" .. "Default: 0",
            Hekili:GetSpellLinkWithTexture(spec.abilities.ferocious_bite.id),
            Hekili:GetSpellLinkWithTexture(spec.abilities.ferocious_bite.id)
        ),
        width = "double",
...
spec:RegisterSetting(
    ...
    0,
    {
        type = "range",
        name = strformat(
            "Minimum time left on %s for %s",
            Hekili:GetSpellLinkWithTexture(spec.abilities.rip.id),
            Hekili:GetSpellLinkWithTexture(spec.abilities.ferocious_bite.id)
        ),
        desc = strformat(
            "If set above zero, %s will not be recommended unless %s has this much time remaining.\n\n" .. "Default: 4",
            Hekili:GetSpellLinkWithTexture(spec.abilities.ferocious_bite.id),
            Hekili:GetSpellLinkWithTexture(spec.abilities.rip.id)
        ),
        width = "double",
...
spec:RegisterSetting(
    ...
    true,
    {
        ...
        desc = strformat(
            "If unchecked, %s trick during %s logic will not be recommended.",
            Hekili:GetSpellLinkWithTexture(spec.abilities.claw.id),
